...
train_enhancement = dict(
    ...
    loss_weights=dict(
        ...
        focal_weight=2.0,
        adaptive_factor=1.0),
    plateau_detection=dict(threshold=0.05, patience=8, min_improvement=0.01),
    visualization=dict(
        enabled=True,
        interval=500,
...
experiment_config = dict(
    name='enhanced_codetr_moco_12epochs',
